...
def create_toolbar():
    ...
    def clean_upload_btn(label, upload_id, filename_id, icon="carbon:document-add"):
        return dmc.Box( 
            style={
                "position": "relative", 
                "paddingBottom": "16px", # Space reserved for the absolute filename
                "display": "flex", 
                "flexDirection": "column", 
                "alignItems": "center",
                "justifyContent": "center" # Ensures vertical centering within the Box
            }, 
            children=[
                 dcc.Upload(
                    id=upload_id,
                ...
                dmc.Text(
                    ...
                    style={
                        "position": "absolute", 
                        "bottom": "-4px", # Positioned outside the flex flow
                        "left": "4px",
                        "maxWidth": "140px", 
                        "whiteSpace": "nowrap", 
                        "overflow": "hidden", 
    ...
    return dmc.Paper(
        ...
        children=dmc.Group(
            ...
            align="center", # Global vertical centering for the toolbar
            children=[
                ...
                dmc.Group(
                    ...
                    children=[
                        dmc.Group(
                            gap="sm", 
                            align="center", # Center buttons vertically relative to each other
                            children=[
